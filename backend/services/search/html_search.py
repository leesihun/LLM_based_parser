...
class HTMLSearcher:
    ...
    def _search_duckduckgo_html(self, query: str, max_results: int) -> List[Dict[str, str]]:
        ...
        # DuckDuckGo HTML endpoint avoids heavy JS
        ...
        for method in ("get", "post"):
            headers = {
                ...
                "Origin": "https://duckduckgo.com" if method == "post" else None,
            }
        ...
        try:
            ...
            if response.headers.get("Content-Encoding") == "br":
                try:
                    ...
                    self.logger.warning("Brave response Brotli decode failed: %s", exc)
            ...
            self.logger.error(f"??[BRAVE] Brave search failed: {exc}")
            import traceback
